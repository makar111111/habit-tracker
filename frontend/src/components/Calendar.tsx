  ...
  return (
    <div className="calendar">
      ...
      <div className="calendar-legend" aria-hidden="true">
        ...
        <span className="day rest" />
        <span>поза розкладом</span>
        <span className="day done" />
        <span>зроблено</span>
      </div>
      <p className="chart-note calendar-note">
        Натисни день, щоб поставити або зняти відмітку. Відмітка до початку посуне дату початку
        звички.
      </p>
    </div>
  );
