...
Create a new $1 named $2, following the patterns already used in this project.
...
Where things go:
- `component` → `frontend/src/components/$2.tsx` + `$2.test.tsx` next to it (Vitest + Testing Library). Named export only, never `export default`.
